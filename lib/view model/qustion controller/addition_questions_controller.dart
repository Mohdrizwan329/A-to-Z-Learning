...
class AdditionQuestionsController extends GetxController {
  ...
  void loadData() {
    final savedData = box.read('addition_questions');
    final savedBatch = box.read('addition_currentBatch');
    final savedCorrect = box.read('addition_correct');
    final savedIncorrect = box.read('addition_incorrect');
  ...
  Future<void> saveData() async {
    ...
    _saveTimer = Timer(const Duration(seconds: 1), () async {
      ...
      await box.write('addition_questions', jsonList);
      await box.write('addition_currentBatch', currentBatch.value);
      await box.write('addition_correct', correct.value);
      await box.write('addition_incorrect', incorrect.value);
    });
  }
