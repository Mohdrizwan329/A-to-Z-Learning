...
class DivisionQuestionsController extends GetxController {
  ...
  void loadData() {
    final savedData = box.read('division_questions');
    final savedBatch = box.read('division_currentBatch');
    final savedCorrect = box.read('division_correct');
    final savedIncorrect = box.read('division_incorrect');
  ...
  void generateNewQuestions() {
    ...
    final newQuestions = List.generate(50, (_) {
      int divisor = rand.nextInt(90) + 10;
      int quotient = rand.nextInt(90) + 10;
      int dividend = divisor * quotient;
      return QuestionModel(dividend, divisor);
    });
  ...
  Future<void> saveData() async {
    ...
    _saveTimer = Timer(const Duration(seconds: 1), () async {
      ...
      await box.write('division_questions', jsonList);
      await box.write('division_currentBatch', currentBatch.value);
      await box.write('division_correct', correct.value);
      await box.write('division_incorrect', incorrect.value);
    });
  }
