...
import 'package:jiyan_learning/view%20model/countries_flags_controller/countries_flags_controller.dart';
...
class _CountriesFlagsPageState extends State<CountriesFlagsPage>
  ...
  final CountriesFlagsController controller = Get.put(
    CountriesFlagsController(),
  );
                  ...
                  return buildFloatingItem(
                    ...
                    child: GradientCard(
                      ...
                      onTap: () {
                        ...
                        Get.to(
                          () =>
                              CountriesFlagsDetailPage(sectionIndex: index),
                        );
                      },
                      child: Stack(
                        children: [
