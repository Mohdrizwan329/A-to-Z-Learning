...
class _ExerciseFitnessPageState extends State<ExerciseFitnessPage>
    with TickerProviderStateMixin, GridAnimationsMixin {
  final ExerciseFitnessController controller = Get.put(
    ExerciseFitnessController(),
  );
                  ...
                  return buildFloatingItem(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Get.to(
                          () => ExerciseFitnessDetailPage(sectionIndex: index),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
