...
class _FlowerLearningPageState extends State<FlowerLearningPage>
  ...
  final FlowerLearningController controller = Get.put(FlowerLearningController());
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: GridView.builder(
          ...
          itemCount: FlowerLearningController.flowers.length,
          itemBuilder: (context, index) {
            final item = FlowerLearningController.flowers[index];
