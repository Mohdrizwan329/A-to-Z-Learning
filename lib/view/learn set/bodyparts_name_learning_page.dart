...
class _BodyPartsLearningPageState extends State<BodyPartsLearningPage>
  ...
  final BodyPartsLearningController controller = Get.put(BodyPartsLearningController());
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: GridView.builder(
          ...
          itemCount: BodyPartsLearningController.bodyParts.length,
          itemBuilder: (context, index) {
            final item = BodyPartsLearningController.bodyParts[index];
