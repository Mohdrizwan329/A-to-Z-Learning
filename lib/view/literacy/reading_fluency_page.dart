...
class _ReadingFluencyPageState extends State<ReadingFluencyPage>
  ...
  final List<Map<String, dynamic>> levelCards = [
    ...
    },
    {
      'name': 'School',
      'emoji': '🏫',
      'subtitle': 'School Stories',
      'levelIndex': 3,
    },
    {
      'name': 'Adventure',
      'emoji': '🚀',
      'subtitle': 'Fun Adventures',
      'levelIndex': 4,
    },
    {
      'name': 'Friendship',
      'emoji': '🤝',
      'subtitle': 'Friend Stories',
      'levelIndex': 5,
    },
  ];
  ...
  void initState() {
    super.initState();
    controller = Get.put(ReadingFluencyController());
      ...
      body: Column(
        children: [
          ...
          Obx(() {
            ...
            final totalLevels = ReadingFluencyController.progressKeys.length;
            for (var key in ReadingFluencyController.progressKeys) {
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final progressKey =
                    ReadingFluencyController.progressKeys[levelIndex];
                  ...
                  return buildFloatingItem(
                    ...
                    child: GradientCard(
                      ...
                      onTap: () {
                        ...
                        Get.to(
                          () =>
                              ReadingFluencyDetailPage(levelIndex: levelIndex),
                        );
                      },
                      child: Stack(
                        children: [
