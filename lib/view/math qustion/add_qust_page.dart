...
class _AdditionQuestionsScreenState extends State<AdditionQuestionsScreen>
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              ...
              if (isSelected)
                Positioned(top: 6, left: 6, child: Text("⭐", style: TextStyle(fontSize: 14))),
            ],
          ),
        ),
      ),
  ...
  void _showScoreDialog(BuildContext context, AdditionQuestionsController controller) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 8),
            Text("Batch Completed!", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ],
        ),
        content: Obx(
          () => Column(
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text("${controller.correct}", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.green)),
                  ...
                  Column(
                    children: [
                      Text("❌", style: TextStyle(fontSize: 32)),
                      Text("${controller.incorrect}", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.red)),
