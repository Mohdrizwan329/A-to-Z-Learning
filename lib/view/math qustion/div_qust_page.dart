...
class _DivisionQuestionsScreenState extends State<DivisionQuestionsScreen>
  ...
  final DivisionQuestionsController controller = Get.put(DivisionQuestionsController());
  ...
  void _showScoreDialog(BuildContext context, DivisionQuestionsController controller) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        backgroundColor: Colors.white,
        title: Row(children: [Text("🎉", style: TextStyle(fontSize: 28)), SizedBox(width: 8), Text("Batch Completed!", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold))]),
        content: Obx(
          () => Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Row(
                ...
                children: [
                  Column(children: [Text("✅", style: TextStyle(fontSize: 32)), Text("${controller.correct}", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.green)), Text("Correct", style: TextStyle(color: Colors.grey))]),
                  Column(children: [Text("❌", style: TextStyle(fontSize: 32)), Text("${controller.incorrect}", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.red)), Text("Incorrect", style: TextStyle(color: Colors.grey))]),
                ],
              ),
            ],
          ),
        ...
        actions: [
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF56D97F), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)), padding: EdgeInsets.symmetric(horizontal: 24, vertical: 12)),
            child: Text("Next 10 Questions ➡️", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
