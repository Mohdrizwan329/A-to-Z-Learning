...
import 'package:jiyan_learning/view%20model/learning_strategy_controller/learning_strategy_controller.dart';
...
class _LearningStrategyPageState extends State<LearningStrategyPage>
  ...
  final LearningStrategyController controller = Get.put(
    LearningStrategyController(),
  );
                  ...
                  return buildFloatingItem(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Get.to(
                          () => LearningStrategyDetailPage(sectionIndex: index),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
