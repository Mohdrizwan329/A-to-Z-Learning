...
import 'package:jiyan_learning/view%20model/think_about_thinking_controller/think_about_thinking_controller.dart';
...
class _ThinkAboutThinkingPageState extends State<ThinkAboutThinkingPage>
  ...
  final ThinkAboutThinkingController controller = Get.put(
    ThinkAboutThinkingController(),
  );
                  ...
                  return buildFloatingItem(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Get.to(
                          () =>
                              ThinkAboutThinkingDetailPage(sectionIndex: index),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
