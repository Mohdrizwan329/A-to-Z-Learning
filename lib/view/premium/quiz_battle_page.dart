...
class _QuizBattlePageState extends State<QuizBattlePage>
  ...
  Map<String, dynamic> _generateMathQuestion(Random random) {
    ...
    final maxNum = _difficulty == 'easy'
        ? 10
        : (_difficulty == 'medium' ? 20 : 50);
  ...
  List<Map<String, dynamic>> _getSciencePool() {
    return [
      ...
      },
      {
        ...
        'a': 'Butterfly',
        'opts': ['Butterfly', 'Bee', 'Bird', 'Beetle'],
      },
      {
        'q': 'What is the hardest natural substance?',
        'a': 'Diamond',
        'opts': ['Diamond', 'Gold', 'Iron', 'Silver'],
      },
      {
        'q': 'How many bones are in the human body?',
        'a': '206',
        'opts': ['206', '106', '306', '156'],
      },
      {
        'q': 'What animal is known as man\'s best friend?',
        'a': 'Dog',
        'opts': ['Dog', 'Cat', 'Horse', 'Rabbit'],
      },
      {
        'q': 'What is the largest planet in our solar system?',
        'a': 'Jupiter',
        'opts': ['Jupiter', 'Saturn', 'Neptune', 'Uranus'],
      },
      {
        'q': 'What is the boiling point of water?',
        'a': '100°C',
        'opts': ['100°C', '90°C', '110°C', '80°C'],
      },
      {
        'q': 'Which organ pumps blood in the body?',
        'a': 'Heart',
        'opts': ['Heart', 'Lungs', 'Brain', 'Liver'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Saturn',
        'opts': ['Saturn', 'Jupiter', 'Mars', 'Neptune'],
      },
      {
        'q': 'What is the center of an atom called?',
        'a': 'Nucleus',
        'opts': ['Nucleus', 'Electron', 'Proton', 'Neutron'],
      },
      {
        'q': 'What force keeps us on the ground?',
        'a': 'Gravity',
        'opts': ['Gravity', 'Friction', 'Magnetism', 'Inertia'],
      },
      {
        'q': 'Which animal lays the largest eggs?',
        'a': 'Ostrich',
        'opts': ['Ostrich', 'Eagle', 'Crocodile', 'Turtle'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Stapes',
        'opts': ['Stapes', 'Femur', 'Tibia', 'Radius'],
      },
      {
        'q': 'Which vitamin comes from sunlight?',
        'a': 'Vitamin D',
        'opts': ['Vitamin D', 'Vitamin A', 'Vitamin C', 'Vitamin B'],
      },
      {
      ...
      {
        'q': 'What makes up about 70% of Earth?',
        'a': 'Water',
        'opts': ['Water', 'Land', 'Air', 'Ice'],
      },
      {
        'q': 'Which is the longest bone in the body?',
        'a': 'Femur',
        'opts': ['Femur', 'Tibia', 'Humerus', 'Spine'],
      },
      {
        'q': 'What do bees make?',
        'a': 'Honey',
        'opts': ['Honey', 'Wax', 'Silk', 'Milk'],
      },
      {
        'q': 'What is the freezing point of water?',
        'a': '0°C',
        'opts': ['0°C', '-10°C', '10°C', '5°C'],
      },
      {
        'q': 'Which sense do ears help with?',
        'a': 'Hearing',
        'opts': ['Hearing', 'Sight', 'Smell', 'Touch'],
      },
      {
        'q': 'What is baby frog called?',
        'a': 'Tadpole',
        'opts': ['Tadpole', 'Puppy', 'Calf', 'Cub'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Thermometer',
        'opts': ['Thermometer', 'Barometer', 'Ruler', 'Scale'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Photosynthesis',
        'opts': ['Photosynthesis', 'Respiration', 'Digestion', 'Osmosis'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Sun',
        'opts': ['Sun', 'Sirius', 'Polaris', 'Alpha Centauri'],
      },
      {
        'q': 'Which animal has the longest neck?',
        'a': 'Giraffe',
        'opts': ['Giraffe', 'Elephant', 'Ostrich', 'Camel'],
      },
      {
        'q': 'What is the Earth\'s natural satellite?',
        'a': 'Moon',
        'opts': ['Moon', 'Sun', 'Mars', 'Star'],
      },
      {
        'q': 'What type of animal is a snake?',
        'a': 'Reptile',
        'opts': ['Reptile', 'Amphibian', 'Mammal', 'Insect'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Blue Whale',
        'opts': ['Blue Whale', 'Elephant', 'Giraffe', 'Shark'],
      },
      {
      ...
      },
      {
        'q': 'What is lava?',
        'a': 'Melted rock',
        'opts': ['Melted rock', 'Hot water', 'Liquid metal', 'Burning gas'],
      },
      {
        'q': 'Which bird cannot fly?',
        'a': 'Penguin',
        'opts': ['Penguin', 'Eagle', 'Parrot', 'Sparrow'],
      },
      {
        'q': 'What is the study of stars called?',
        'a': 'Astronomy',
        'opts': ['Astronomy', 'Astrology', 'Biology', 'Geography'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Absorb water',
        'opts': ['Absorb water', 'Make food', 'Produce seeds', 'Attract bees'],
      },
      {
      ...
      {
        'q': 'Which gas is needed for fire to burn?',
        'a': 'Oxygen',
      ...
      },
      {
        ...
        'a': 'Elephant',
        'opts': ['Elephant', 'Giraffe', 'Rhino', 'Hippo'],
      },
      {
        'q': 'What are clouds made of?',
        'a': 'Water droplets',
        'opts': ['Water droplets', 'Cotton', 'Smoke', 'Dust'],
      },
      {
        'q': 'Which planet is famous for its Great Red Spot?',
        'a': 'Jupiter',
        'opts': ['Jupiter', 'Mars', 'Saturn', 'Neptune'],
      },
      {
        'q': 'What is the main source of energy for Earth?',
        'a': 'Sun',
        'opts': ['Sun', 'Moon', 'Wind', 'Water'],
      },
      {
      ...
      {
        'q': 'What is the outer layer of Earth called?',
        'a': 'Crust',
        'opts': ['Crust', 'Mantle', 'Core', 'Surface'],
      },
      {
        'q': 'Which is the fastest land animal?',
        'a': 'Cheetah',
        'opts': ['Cheetah', 'Lion', 'Horse', 'Tiger'],
      },
      {
        'q': 'What is a group of stars called?',
        'a': 'Constellation',
        'opts': ['Constellation', 'Galaxy', 'Nebula', 'Cluster'],
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getGKPool() {
    return [
      ...
      },
      {
        ...
        'a': 'Peacock',
        'opts': ['Peacock', 'Parrot', 'Eagle', 'Sparrow'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Diwali',
        'opts': ['Diwali', 'Holi', 'Eid', 'Christmas'],
      },
      {
        'q': 'What is the currency of India?',
        'a': 'Rupee',
        'opts': ['Rupee', 'Dollar', 'Pound', 'Euro'],
      },
      {
        'q': 'Which is the smallest continent?',
        'a': 'Australia',
        'opts': ['Australia', 'Europe', 'Antarctica', 'Africa'],
      },
      {
        'q': 'What is the capital of USA?',
        'a': 'Washington DC',
        'opts': ['Washington DC', 'New York', 'Los Angeles', 'Chicago'],
      },
      {
      ...
      {
        'q': 'Which country has the Taj Mahal?',
        'a': 'India',
        'opts': ['India', 'Pakistan', 'Nepal', 'Bangladesh'],
      },
      {
        'q': 'What is the national flower of India?',
        'a': 'Lotus',
        'opts': ['Lotus', 'Rose', 'Sunflower', 'Lily'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Nile',
        'opts': ['Nile', 'Amazon', 'Ganges', 'Yamuna'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Hockey',
        'opts': ['Hockey', 'Cricket', 'Football', 'Kabaddi'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Autumn',
        'opts': ['Autumn', 'Winter', 'Spring', 'Monsoon'],
      },
      {
        'q': 'Which season comes after winter?',
        'a': 'Spring',
        'opts': ['Spring', 'Summer', 'Autumn', 'Monsoon'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Tokyo',
        'opts': ['Tokyo', 'Osaka', 'Kyoto', 'Beijing'],
      },
      {
        'q': 'What is the capital of France?',
        'a': 'Paris',
        'opts': ['Paris', 'London', 'Rome', 'Berlin'],
      },
      {
        'q': 'Which is the largest country by area?',
        'a': 'Russia',
        'opts': ['Russia', 'China', 'USA', 'Canada'],
      },
      {
        'q': 'What color is the stop sign?',
        'a': 'Red',
      ...
      },
      {
        ...
        'a': 'Burj Khalifa',
        'opts': ['Burj Khalifa', 'Eiffel Tower', 'Big Ben', 'Empire State'],
      },
      {
        'q': 'What is the national fruit of India?',
        'a': 'Mango',
        'opts': ['Mango', 'Apple', 'Banana', 'Orange'],
      },
      {
        'q': 'Which country is famous for Pyramids?',
        'a': 'Egypt',
        'opts': ['Egypt', 'India', 'China', 'Greece'],
      },
      {
        'q': 'What is the capital of China?',
        'a': 'Beijing',
        'opts': ['Beijing', 'Shanghai', 'Tokyo', 'Seoul'],
      },
      {
        'q': 'Which is the most spoken language?',
        'a': 'English',
        'opts': ['English', 'Hindi', 'Spanish', 'French'],
      },
      {
        'q': 'What is the capital of UK?',
        'a': 'London',
        'opts': ['London', 'Paris', 'Dublin', 'Edinburgh'],
      },
      {
      ...
      {
        'q': 'Which planet is known as Blue Planet?',
        'a': 'Earth',
        'opts': ['Earth', 'Neptune', 'Uranus', 'Venus'],
      },
      {
        'q': 'What shape is a football?',
        'a': 'Sphere',
        'opts': ['Sphere', 'Cube', 'Cylinder', 'Cone'],
      },
      {
        'q': 'Which animal is called Ship of Desert?',
        'a': 'Camel',
        'opts': ['Camel', 'Horse', 'Elephant', 'Donkey'],
      },
      {
        'q': 'Which country gave us the game of chess?',
        'a': 'India',
        'opts': ['India', 'China', 'Russia', 'England'],
      },
      {
      ...
      {
        'q': 'Which festival is called Festival of Colors?',
        'a': 'Holi',
        'opts': ['Holi', 'Diwali', 'Eid', 'Pongal'],
      },
      {
        'q': 'What is the currency of USA?',
        'a': 'Dollar',
        'opts': ['Dollar', 'Pound', 'Euro', 'Yen'],
      },
      {
        'q': 'Which is the largest desert in the world?',
        'a': 'Sahara',
        'opts': ['Sahara', 'Thar', 'Gobi', 'Kalahari'],
      },
      {
        'q': 'How many Olympic rings are there?',
        'a': '5',
        'opts': ['5', '4', '6', '7'],
      },
      {
        ...
        'a': 'Mount Everest',
        'opts': ['Mount Everest', 'K2', 'Kangchenjunga', 'Makalu'],
      },
      {
        'q': 'What does Indian flag\'s green color represent?',
        'a': 'Fertility',
        'opts': ['Fertility', 'Peace', 'Courage', 'Truth'],
      },
      {
        'q': 'Who was the first Prime Minister of India?',
        'a': 'Nehru',
        'opts': ['Nehru', 'Gandhi', 'Patel', 'Ambedkar'],
      },
      {
        'q': 'Which river is called Ganga in India?',
        'a': 'Ganges',
        'opts': ['Ganges', 'Yamuna', 'Narmada', 'Godavari'],
      },
      {
      ...
      {
        'q': 'How many legs does a chair usually have?',
        'a': '4',
        'opts': ['4', '3', '2', '5'],
      },
      {
        ...
        'a': 'Tuesday',
        'opts': ['Tuesday', 'Wednesday', 'Thursday', 'Sunday'],
      },
      {
        'q': 'What is the first month of the year?',
        'a': 'January',
        'opts': ['January', 'February', 'March', 'December'],
      },
      {
        'q': 'Which instrument is used to measure weight?',
        'a': 'Scale',
        'opts': ['Scale', 'Ruler', 'Thermometer', 'Clock'],
      },
      {
        'q': 'What is the national anthem of India?',
        'a': 'Jana Gana Mana',
        'opts': ['Jana Gana Mana', 'Vande Mataram', 'Sare Jahan Se', 'Jai Ho'],
      },
      {
        'q': 'Who invented the telephone?',
        'a': 'Alexander Bell',
        'opts': ['Alexander Bell', 'Edison', 'Newton', 'Tesla'],
      },
      {
        'q': 'Which is the smallest planet?',
        'a': 'Mercury',
        'opts': ['Mercury', 'Mars', 'Venus', 'Pluto'],
      },
      {
        'q': 'What does a barber do?',
        'a': 'Cuts hair',
        'opts': ['Cuts hair', 'Cooks food', 'Drives bus', 'Teaches'],
      },
      {
        'q': 'Which animal gives us wool?',
        'a': 'Sheep',
        'opts': ['Sheep', 'Goat', 'Cow', 'Dog'],
      },
      {
        'q': 'Which is the largest continent?',
        'a': 'Asia',
        'opts': ['Asia', 'Africa', 'Europe', 'America'],
      },
      {
        'q': 'What is the capital of Germany?',
        'a': 'Berlin',
        'opts': ['Berlin', 'Munich', 'Hamburg', 'Frankfurt'],
      },
    ];
  }
    ...
    return [
      {
        ...
        'a': 'Cold',
        'opts': ['Cold', 'Warm', 'Cool', 'Wet'],
      },
      {
        'q': 'What is the plural of "Child"?',
        'a': 'Children',
        'opts': ['Children', 'Childs', 'Childrens', 'Child'],
      },
      {
        'q': 'What is the past tense of "Go"?',
        'a': 'Went',
        'opts': ['Went', 'Goed', 'Gone', 'Going'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Small',
        'opts': ['Small', 'Large', 'Huge', 'Tall'],
      },
      {
        'q': 'What is a baby dog called?',
        'a': 'Puppy',
        'opts': ['Puppy', 'Kitten', 'Calf', 'Cub'],
      },
      {
        'q': 'What rhymes with "Cat"?',
        'a': 'Bat',
        'opts': ['Bat', 'Dog', 'Cup', 'Sun'],
      },
      {
        'q': 'What is the opposite of "Day"?',
        'a': 'Night',
        'opts': ['Night', 'Morning', 'Evening', 'Afternoon'],
      },
      {
        'q': 'Which is a verb?',
        'a': 'Run',
        'opts': ['Run', 'Beautiful', 'Red', 'Table'],
      },
      {
        'q': 'What is a group of fish called?',
        'a': 'School',
        'opts': ['School', 'Herd', 'Flock', 'Pack'],
      },
      {
        'q': 'What is the opposite of "Fast"?',
        'a': 'Slow',
        'opts': ['Slow', 'Quick', 'Rapid', 'Speedy'],
      },
      {
        'q': 'What is the plural of "Mouse"?',
        'a': 'Mice',
        'opts': ['Mice', 'Mouses', 'Mices', 'Mouse'],
      },
      {
      ...
      },
      {
        ...
        'a': 'Sad',
        'opts': ['Sad', 'Angry', 'Tired', 'Bored'],
      },
      {
        'q': 'Which is a noun?',
        'a': 'Table',
        'opts': ['Table', 'Run', 'Beautiful', 'Quickly'],
      },
      {
        'q': 'What is a baby cat called?',
        'a': 'Kitten',
        'opts': ['Kitten', 'Puppy', 'Calf', 'Lamb'],
      },
      {
        'q': 'What rhymes with "Sun"?',
        'a': 'Fun',
        'opts': ['Fun', 'Sit', 'Ran', 'Cup'],
      },
      {
        'q': 'What is the opposite of "Up"?',
        'a': 'Down',
        'opts': ['Down', 'Over', 'Under', 'Side'],
      },
      {
        'q': 'Which is an adjective?',
        'a': 'Beautiful',
        'opts': ['Beautiful', 'Run', 'Table', 'Quickly'],
      },
      {
        'q': 'What is a group of lions called?',
        'a': 'Pride',
        'opts': ['Pride', 'Herd', 'Pack', 'Flock'],
      },
      {
        'q': 'What is the opposite of "Old"?',
        'a': 'Young',
        'opts': ['Young', 'New', 'Fresh', 'Small'],
      },
      {
        'q': 'What is the plural of "Tooth"?',
        'a': 'Teeth',
        'opts': ['Teeth', 'Tooths', 'Teeths', 'Toothes'],
      },
      {
        'q': 'What is the past tense of "Run"?',
        'a': 'Ran',
        'opts': ['Ran', 'Runned', 'Running', 'Runed'],
      },
      {
        'q': 'What is the opposite of "Light"?',
        'a': 'Dark',
        'opts': ['Dark', 'Bright', 'Dim', 'Heavy'],
      },
      {
        'q': 'Which word is a color?',
        'a': 'Blue',
        'opts': ['Blue', 'Walk', 'House', 'Happy'],
      },
      {
        'q': 'What is a baby cow called?',
        'a': 'Calf',
        'opts': ['Calf', 'Puppy', 'Kitten', 'Lamb'],
      },
      {
        'q': 'What rhymes with "Dog"?',
        'a': 'Log',
        'opts': ['Log', 'Cup', 'Run', 'Sit'],
      },
      {
        'q': 'What is the opposite of "Open"?',
        'a': 'Close',
        'opts': ['Close', 'Shut', 'Lock', 'Wide'],
      },
      {
        'q': 'Which is an adverb?',
        'a': 'Quickly',
        'opts': ['Quickly', 'Quick', 'Table', 'Red'],
      },
      {
        'q': 'What is a group of wolves called?',
        'a': 'Pack',
        'opts': ['Pack', 'Herd', 'Flock', 'Pride'],
      },
      {
        'q': 'What is the opposite of "Tall"?',
        'a': 'Short',
        'opts': ['Short', 'Small', 'Tiny', 'Low'],
      },
      {
        'q': 'What is the plural of "Foot"?',
        'a': 'Feet',
        'opts': ['Feet', 'Foots', 'Feets', 'Footes'],
      },
      {
        'q': 'What is the past tense of "See"?',
        'a': 'Saw',
        'opts': ['Saw', 'Seed', 'Seen', 'Seeing'],
      },
      {
        'q': 'What is the opposite of "Soft"?',
        'a': 'Hard',
        'opts': ['Hard', 'Rough', 'Strong', 'Tough'],
      },
      {
        'q': 'What starts with "A" and keeps doctors away?',
        'a': 'Apple',
        'opts': ['Apple', 'Ant', 'Air', 'Arm'],
      },
      {
        'q': 'What is a baby sheep called?',
        'a': 'Lamb',
        'opts': ['Lamb', 'Calf', 'Kid', 'Foal'],
      },
      {
        'q': 'What rhymes with "Ball"?',
        'a': 'Tall',
        'opts': ['Tall', 'Bell', 'Bull', 'Bill'],
      },
      {
        'q': 'What is the opposite of "Wet"?',
        'a': 'Dry',
        'opts': ['Dry', 'Cold', 'Hot', 'Warm'],
      },
      {
        'q': 'Which word means "Very big"?',
        'a': 'Huge',
        'opts': ['Huge', 'Tiny', 'Small', 'Little'],
      },
      {
        'q': 'What is a group of cows called?',
        'a': 'Herd',
        'opts': ['Herd', 'Pack', 'Flock', 'Pride'],
      },
      {
        'q': 'What is the opposite of "Rich"?',
        'a': 'Poor',
        'opts': ['Poor', 'Cheap', 'Low', 'Empty'],
      },
      {
        'q': 'What is the plural of "Man"?',
        'a': 'Men',
        'opts': ['Men', 'Mans', 'Mens', 'Manes'],
      },
      {
        'q': 'What is the past tense of "Write"?',
        'a': 'Wrote',
        'opts': ['Wrote', 'Writed', 'Written', 'Writing'],
      },
      {
        'q': 'What is the opposite of "Clean"?',
        'a': 'Dirty',
        'opts': ['Dirty', 'Messy', 'Ugly', 'Dark'],
      },
      {
        'q': 'Which word means "Angry"?',
        'a': 'Furious',
        'opts': ['Furious', 'Happy', 'Tired', 'Calm'],
      },
      {
        'q': 'What is a baby horse called?',
        'a': 'Foal',
        'opts': ['Foal', 'Calf', 'Lamb', 'Puppy'],
      },
      {
        'q': 'What rhymes with "Star"?',
        'a': 'Car',
        'opts': ['Car', 'Sit', 'Run', 'Cup'],
      },
      {
        'q': 'What is the opposite of "Push"?',
        'a': 'Pull',
        'opts': ['Pull', 'Press', 'Hit', 'Hold'],
      },
      {
        'q': 'What is the plural of "Woman"?',
        'a': 'Women',
        'opts': ['Women', 'Womans', 'Womens', 'Womanes'],
      },
      {
        'q': 'What is the past tense of "Sing"?',
        'a': 'Sang',
        'opts': ['Sang', 'Singed', 'Sung', 'Singing'],
      },
      {
        'q': 'What is the opposite of "Love"?',
        'a': 'Hate',
        'opts': ['Hate', 'Like', 'Angry', 'Fear'],
      },
      {
        'q': 'Which word means "Scared"?',
        'a': 'Afraid',
        'opts': ['Afraid', 'Brave', 'Happy', 'Strong'],
      },
      {
        'q': 'What is the opposite of "Start"?',
        'a': 'Stop',
        'opts': ['Stop', 'End', 'Finish', 'Break'],
      },
      {
        'q': 'What is a group of birds called?',
        'a': 'Flock',
        'opts': ['Flock', 'Herd', 'Pack', 'School'],
      },
      {
        'q': 'What is the past tense of "Buy"?',
        'a': 'Bought',
        'opts': ['Bought', 'Buyed', 'Buying', 'Buyd'],
      },
      {
        'q': 'What is the opposite of "Laugh"?',
        'a': 'Cry',
        'opts': ['Cry', 'Smile', 'Shout', 'Whisper'],
      },
      {
        'q': 'Which word means "Very small"?',
        'a': 'Tiny',
        'opts': ['Tiny', 'Huge', 'Big', 'Large'],
      },
      {
        'q': 'What rhymes with "Book"?',
        'a': 'Cook',
        'opts': ['Cook', 'Back', 'Bike', 'Bank'],
      },
      {
        'q': 'What is the past tense of "Drink"?',
        'a': 'Drank',
        'opts': ['Drank', 'Drinked', 'Drunk', 'Drinking'],
      },
      {
        'q': 'What is the opposite of "Full"?',
        'a': 'Empty',
        'opts': ['Empty', 'Half', 'Low', 'Less'],
      },
    ];
  }
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.play_arrow, size: 28.r),
                  SizedBox(width: 8.w),
                  Flexible(
                    child: Text(
                      'START BATTLE',
  ...
  Widget _buildCategoryGrid() {
    final categories = [
      {'id': 'math', 'name': 'Math', 'icon': '🧮', 'count': '∞'},
      {
        ...
        'name': 'Science',
        'icon': '🔬',
        'count': '${_getSciencePool().length}',
      },
      {
        'id': 'gk',
        'name': 'GK',
        'icon': '🌍',
        'count': '${_getGKPool().length}',
      },
      {
        'id': 'english',
        'name': 'English',
        'icon': '📚',
        'count': '${_getEnglishPool().length}',
      },
    ];
      ...
      children: difficulties.map((diff) {
        ...
        return Expanded(
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              duration: const Duration(milliseconds: 200),
              margin: EdgeInsets.only(right: diff['id'] != 'hard' ? 8 : 0),
      ...
      children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.timer, color: Colors.white, size: 16.r),
                            SizedBox(width: 4.w),
                            Text(
                              '$_timeLeft s',
                              style: GoogleFonts.nunito(
        ...
        AnimatedBuilder(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Text(question['emoji'], style: const TextStyle(fontSize: 36)),
  ...
  Widget _buildResultStat(String label, String value) {
    return Column(
      children: [
        ...
        Text(label, style: GoogleFonts.nunito(color: Colors.grey.shade600)),
      ],
    );
  }
}
