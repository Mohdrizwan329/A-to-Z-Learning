...
class AccessibilitySettingsPage extends StatelessWidget {
          ...
          children: [
            ...
            _buildSettingsCard([
              Obx(() => SwitchListTile(
                    ...
                    subtitle: const Text('Uses OpenDyslexic font for easier reading'),
              ...
              Obx(() => SwitchListTile(
                    ...
                    subtitle: const Text('Makes all text bold for better visibility'),
                    value: accessibilityService.boldTextEnabled.value,
                    onChanged: (value) =>
                        accessibilityService.setBoldText(value),
                    secondary: const Text('𝐁', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                  )),
            ]),
            ...
            _buildSettingsCard([
              Obx(() => SwitchListTile(
                    ...
                    subtitle: const Text('Adjust colors for color vision deficiency'),
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      trailing: DropdownButton<ColorBlindType>(
                        ...
                        onChanged: (type) {
                          if (type != null) {
                            accessibilityService.setColorBlindMode(true, type: type);
                          }
                        },
              ...
              Obx(() => SwitchListTile(
                    ...
                    subtitle: const Text('Makes buttons bigger and easier to tap'),
            ...
            _buildSettingsCard([
              ...
              Obx(() => SwitchListTile(
                    ...
                    subtitle: const Text('Highlights active content, dims surroundings'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        runSpacing: 8,
                        children: [
                          _buildColorPreview('Red', Colors.red, accessibilityService),
                          _buildColorPreview('Green', Colors.green, accessibilityService),
                          _buildColorPreview('Blue', Colors.blue, accessibilityService),
                          _buildColorPreview('Yellow', Colors.yellow, accessibilityService),
                          _buildColorPreview('Orange', Colors.orange, accessibilityService),
                        ],
                      ),
                    ],
                  ),
  ...
  Widget _buildColorPreview(
      String name, Color color, AccessibilityService service) {
