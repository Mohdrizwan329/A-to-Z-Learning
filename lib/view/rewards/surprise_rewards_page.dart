...
class _SurpriseRewardsPageState extends State<SurpriseRewardsPage>
  ...
  void _openMysteryBox() async {
    ...
    final rarityPrizes = mysteryPrizes
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    prize['color'],
                    prize['color'].withValues(alpha: 0.7),
                  ],
                ),
                ...
                children: [
                  ...
                  if (prize.containsKey('rarity'))
                    Container(
                      ...
                      child: Text(
                        prize['rarity'].toString().toUpperCase(),
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 12,
                        ),
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(
              text: "Spin",
              icon: Icon(Icons.casino, size: 20.r),
            ),
            Tab(
              text: "Mystery",
              icon: Icon(Icons.card_giftcard, size: 20.r),
            ),
            Tab(
              text: "Scratch",
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Text(
              "$dailySpinsLeft spins left today",
              style: const TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.bold,
              ),
          ...
          Stack(
            ...
            children: [
                  ...
                  return Transform.rotate(
                    ...
                    child: Container(
                      ...
                      child: CustomPaint(
                        ...
                        child: SizedBox(width: 280.w, height: 280.h),
                      ),
                    ),
                  );
                },
              ...
              // Center button
              GestureDetector(
                onTap: dailySpinsLeft > 0 && !isSpinning
                    ? () {
                        TtsService.to.speak('Spin Wheel');
                        _spinWheel();
                      }
                    : null,
                child: Container(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 4.h),
          Text(
            "Open the box for surprise rewards!",
            style: TextStyle(color: Colors.white.withValues(alpha: 0.8)),
          ),
          SizedBox(height: 8.h),
          Container(
            ...
            child: Text(
              "$dailyBoxesLeft boxes left today",
              style: const TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.bold,
              ),
          ...
          // Mystery Box
          GestureDetector(
            onTap: dailyBoxesLeft > 0 && !isOpening
                ? () {
                    TtsService.to.speak('Mystery Box');
                    _openMysteryBox();
                  }
                : null,
                    ...
                    children: [
                      ...
                      if (boxOpened)
                        ...List.generate(8, (i) {
                          ...
                          return Positioned(
                            left:
                                100.w + cos(angle) * 120 * _openAnimation.value,
                            top:
                                100.h + sin(angle) * 120 * _openAnimation.value,
                            child: Opacity(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Scratch Card
          GestureDetector(
            onTap: dailyScratchLeft > 0 && !scratchRevealed
                ? () {
                    TtsService.to.speak('Scratch Card');
                    _scratchCard();
                  }
                : null,
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: scratchRevealed
                      ? [
                          scratchPrize?['color'] ?? Colors.purple,
                          (scratchPrize?['color'] ?? Colors.purple).withValues(
                            alpha: 0.7,
                          ),
                        ]
                      : dailyScratchLeft > 0
                ...
                children: [
                  ...
                  if (!scratchRevealed)
                    Positioned.fill(
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(24.r),
                        child: CustomPaint(painter: ScratchPatternPainter()),
                      ),
                    ),
                  // Content
                  Column(
                    ...
                    children: [
                      if (!scratchRevealed) ...[
                        Icon(Icons.touch_app, color: Colors.white, size: 50.r),
                        SizedBox(height: 12.h),
                        const Text(
                          "TAP TO SCRATCH",
                          style: TextStyle(
