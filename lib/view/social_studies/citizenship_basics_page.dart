...
import 'package:jiyan_learning/view%20model/citizenship_basics_controller/citizenship_basics_controller.dart';
...
class _CitizenshipBasicsPageState extends State<CitizenshipBasicsPage>
  ...
  void initState() {
    super.initState();
    // floatRange: 3.0 to match home screen (±3px bobbing)
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Obx(() {
                  ...
                  // Float animation only - same as home screen cards
