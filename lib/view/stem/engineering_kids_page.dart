...
import 'package:jiyan_learning/view%20model/engineering_kids_controller/engineering_kids_controller.dart';
...
class _EngineeringKidsPageState extends State<EngineeringKidsPage>
  ...
  final EngineeringKidsController controller =
      Get.put(EngineeringKidsController());
          ...
          Obx(() {
            final progress =
                ProgressService.to.getProgressPercentage(
                  ProgressService.kEngineeringKids,
                ) /
                100;
