...
import 'package:jiyan_learning/view%20model/climate_awareness_controller/climate_awareness_controller.dart';
...
class _ClimateAwarenessPageState extends State<ClimateAwarenessPage>
  ...
  final ClimateAwarenessController controller = Get.put(
    ClimateAwarenessController(),
  );
          ...
          Obx(() {
            final progress =
                ProgressService.to.getProgressPercentage(
                  ProgressService.kClimateAwareness,
                ) /
                100;
                  ...
                  return buildFloatingItem(
                    ...
                    child: GradientCard(
                      ...
                      onTap: () {
                        ...
                        Get.to(
                          () => ClimateAwarenessDetailPage(sectionIndex: index),
                        );
                      },
                      child: Stack(
                        children: [
