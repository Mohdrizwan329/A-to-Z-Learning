  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      'content': [
        {
          'icon': '🔄',
          'text': 'Recycling means turning old things into new things',
        },
        {'icon': '🌍', 'text': 'It helps keep our Earth clean and healthy'},
        {
          'icon': '🗑️',
          'text': 'Instead of throwing things away, we give them a new life',
        },
        {
          'icon': '🏭',
          'text': 'Old materials go to special factories to become new items',
        },
        {
          'icon': '💚',
          'text': 'Recycling is one of the best ways to help our planet!',
        },
      ],
    },
    {
      ...
      'recyclable': [
        {
          'item': 'Paper',
          'emoji': '📄',
          'tip': 'Newspapers, magazines, notebooks',
        },
        {'item': 'Cardboard', 'emoji': '📦', 'tip': 'Boxes, packaging'},
        {
          'item': 'Plastic Bottles',
          'emoji': '🍶',
          'tip': 'Water and juice bottles',
        },
        {
          'item': 'Glass Bottles',
          'emoji': '🍾',
          'tip': 'Jam jars, sauce bottles',
        },
        {'item': 'Metal Cans', 'emoji': '🥫', 'tip': 'Food tins, drink cans'},
        {
          'item': 'Clothes',
          'emoji': '👕',
          'tip': 'Donate or recycle old clothes',
        },
      ],
    },
    {
      ...
      'notRecyclable': [
        {
          'item': 'Food-stained paper',
          'emoji': '🍕',
          'why': 'Oil and food makes it dirty',
        },
    ...
    },
    {
      ...
      'tips': [
        {
          'tip':
              'Always check if something can be recycled before throwing it away',
          'emoji': '🔍',
        },
        {'tip': 'Rinse containers before recycling them', 'emoji': '🚿'},
        {'tip': 'Flatten cardboard boxes to save space', 'emoji': '📦'},
        {
          'tip': 'Teach your friends and family about recycling',
          'emoji': '👨‍👩‍👧‍👦',
        },
