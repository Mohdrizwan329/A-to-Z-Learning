...
import 'package:jiyan_learning/view%20model/recycling_kids_controller/recycling_kids_controller.dart';
...
class _RecyclingKidsPageState extends State<RecyclingKidsPage>
  ...
  final RecyclingKidsController controller = Get.put(RecyclingKidsController());
          ...
          Obx(() {
            final progress =
                ProgressService.to.getProgressPercentage(
                  ProgressService.kRecyclingKids,
                ) /
                100;
                  ...
                  return buildFloatingItem(
                    ...
                    child: GradientCard(
                      ...
                      onTap: () {
                        ...
                        Get.to(
                          () => RecyclingKidsDetailPage(sectionIndex: index),
                        );
                      },
                      child: Stack(
                        children: [
