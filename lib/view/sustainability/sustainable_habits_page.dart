...
import 'package:jiyan_learning/view%20model/sustainable_habits_controller/sustainable_habits_controller.dart';
...
class _SustainableHabitsPageState extends State<SustainableHabitsPage>
  ...
  final SustainableHabitsController controller = Get.put(
    SustainableHabitsController(),
  );
          ...
          Obx(() {
            final progress =
                ProgressService.to.getProgressPercentage(
                  ProgressService.kSustainableHabits,
                ) /
                100;
                  ...
                  return buildFloatingItem(
                    ...
                    child: GradientCard(
                      ...
                      onTap: () {
                        ...
                        Get.to(
                          () =>
                              SustainableHabitsDetailPage(sectionIndex: index),
                        );
                      },
                      child: Stack(
                        children: [
