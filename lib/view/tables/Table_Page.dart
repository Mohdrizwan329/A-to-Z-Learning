...
class _TableScreenState extends State<TableScreen>
  ...
  final List<List<Color>> tableGradients = [
  ...
  List<Color> _getGradient(int index) {
    return tableGradients[index % tableGradients.length];
  }
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Obx(() {
              ...
              child: _buildTableCard(number, gradient, isSelected, index),
            );
            });
          },
        ),
  ...
  Widget _buildTableCard(int number, List<Color> gradient, bool isSelected, int index) {
