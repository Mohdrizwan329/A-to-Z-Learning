...
class _StrokeOrderPageState extends State<StrokeOrderPage>
  ...
  final List<Map<String, dynamic>> characters = [
    {
      ...
      'strokes': [
        {
          'start': Offset(0.5, 1.0),
          'end': Offset(0.2, 0.0),
          'description': 'Left diagonal up',
        },
        {
          'start': Offset(0.5, 1.0),
          'end': Offset(0.8, 0.0),
          'description': 'Right diagonal up',
        },
        {
          'start': Offset(0.35, 0.5),
          'end': Offset(0.65, 0.5),
    ...
    },
    {
      ...
      'strokes': [
        {
          'start': Offset(0.3, 0.0),
          'end': Offset(0.3, 1.0),
          'description': 'Vertical line down',
        },
        {
          'start': Offset(0.3, 0.0),
          'end': Offset(0.6, 0.0),
        ...
        {
          'start': Offset(0.6, 0.0),
          'end': Offset(0.7, 0.25),
          'description': 'Top right curve',
        },
        {
          'start': Offset(0.7, 0.25),
          'end': Offset(0.3, 0.5),
          'description': 'Middle curve',
        },
        {
          'start': Offset(0.3, 0.5),
          'end': Offset(0.7, 0.75),
          'description': 'Bottom curve out',
        },
        {
          'start': Offset(0.7, 0.75),
          'end': Offset(0.3, 1.0),
          'description': 'Bottom curve in',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      'strokes': [
        ...
        },
        {
          'start': Offset(0.3, 0.0),
          'end': Offset(0.7, 0.5),
          'description': 'Curve out',
        },
        {
          'start': Offset(0.7, 0.5),
          'end': Offset(0.3, 1.0),
          'description': 'Curve in',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      'strokes': [
        {
          'start': Offset(0.4, 0.2),
          'end': Offset(0.5, 0.0),
          'description': 'Small diagonal',
        },
        {
          'start': Offset(0.5, 0.0),
          'end': Offset(0.5, 1.0),
          'description': 'Vertical line down',
        },
        {
      ...
      'strokes': [
        {
          ...
          'end': Offset(0.5, 0.0),
          'description': 'Top curve start',
        },
        {
          'start': Offset(0.5, 0.0),
          'end': Offset(0.75, 0.3),
          'description': 'Top curve end',
        },
        {
          'start': Offset(0.75, 0.3),
          'end': Offset(0.25, 1.0),
          'description': 'Diagonal down',
        },
        {
          'start': Offset(0.25, 1.0),
          'end': Offset(0.75, 1.0),
          'description': 'Bottom line',
        },
      ],
    },
    {
      ...
      'strokes': [
        {
          'start': Offset(0.25, 0.0),
          'end': Offset(0.7, 0.0),
          'description': 'Top line',
        },
        {
          'start': Offset(0.7, 0.0),
          'end': Offset(0.4, 0.5),
          'description': 'Upper diagonal',
        },
        {
          'start': Offset(0.4, 0.5),
          'end': Offset(0.7, 0.75),
          'description': 'Middle curve',
        },
        {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        icon: Icon(
                          isAnimating ? Icons.hourglass_top : Icons.play_arrow,
                          size: 28.r,
                        ),
                        label: Text(
